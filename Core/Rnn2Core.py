...
class Rnn2Core(AbstractRnnCore):
    ...
    def pasteModel(self, model_dict):
        ...
        #print('SUM2', np.sum(self.snp_k))
        self.SSPs = model_dict['SSPs']
        self.neu_states = model_dict['neu_states']
        #self.neu_current_values = model_dict['neu_current_values']
        ...
        self.todaystr = model_dict['todaystr']
    ...
    def finishProcessSignals(self):
        ...
        if self.common_params.processing_type == 'Predict':
            self.io_device.analyzeOutputsPredict(self.common_params.predictStepsNum, self.todaystr)
