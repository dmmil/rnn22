...
class AbstractIODevice:
    ...
    def modify_for_predict(self, num: int):
        self.etalon_sample = []
    ...
    def modify_for_novelty_filter(self, shift: int, num: int):
...
class WordConnectionsIODevice(AbstractIODevice):
    ...
    def set_dictionary_filename(self, dictionary_file: str):
    ...
    def send_ssp_to_output(self, output_field_route_index: int, ssp: np.ndarray):
    ...
    def set_input_data_filename(self, input_data_filename: str):
        self.reset()
    ...
    def analyze_outputs_predict(self, last_steps_num: int, to_day_str: str):
    ...
    def analyze_outputs_novelty_filter(self, last_steps_analyzed: int):
