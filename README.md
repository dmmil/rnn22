...
1. [Описание](#описание)
2. [Демо](#демо)
3. [Как использовать с графическим интерфейсом](#как-использовать-с-графическим-интерфейсом)
4. [Как использовать из командной строки](#как-использовать-из-командной-строки)
...
## Как использовать с графическим интерфейсом
...
Исследование проводится при поддержке [Исследовательского центра сильного искусственного интеллекта в промышленности](https://sai.itmo.ru/) [Университета ИТМО](https://itmo.ru) в рамках мероприятия программы центра: Разработка и испытания экспериментального образца библиотеки алгоритмов сильного ИИ в части интеллектуальной детекции событий и смыслов на основе мультимодальных данных (текст, звук, изображения в разных диапазонах) для задач распознавания режимов работы и неисправностей оборудования.
